...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  return (
    <Link
      ...
      className="group flex w-full flex-col items-center gap-4 rounded-2xl border border-stone-600 p-8 duration-200 hover:border-stone-100 md:flex-row md:justify-between"
    >
